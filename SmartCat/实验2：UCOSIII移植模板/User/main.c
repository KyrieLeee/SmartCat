...
//		OSTaskQPend(0, OS_OPT_PEND_BLOCKING, &msg_size, &ts, &err);
//		LCD_ShowString(10,10,tftlcd_data.width,tftlcd_data.height,12,(char *)ts);
  		LCD_ShowString(10,30,tftlcd_data.width,tftlcd_data.height,16,sttr);
